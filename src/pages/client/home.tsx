...
export default function HomePage() {
      ...
      <div className="grid grid-cols-4 gap-1 mb-4">
        <div
          className={`p-2 text-center rounded-md cursor-pointer ${
            activeTab === "all" ? "bg-primary text-white" : "bg-gray-100"
          }`}
          onClick={() => setActiveTab("all")}
        >
        ...
        <div
          className={`p-2 text-center rounded-md cursor-pointer ${
            activeTab === "a" ? "bg-primary text-white" : "bg-gray-100"
          }`}
          onClick={() => setActiveTab("a")}
        >
        ...
        <div
          className={`p-2 text-center rounded-md cursor-pointer ${
            activeTab === "b" ? "bg-primary text-white" : "bg-gray-100"
          }`}
          onClick={() => setActiveTab("b")}
        >
        ...
        <div
          className={`p-2 text-center rounded-md cursor-pointer ${
            activeTab === "c" ? "bg-primary text-white" : "bg-gray-100"
          }`}
          onClick={() => setActiveTab("c")}
        >
  ...
  return (
    <div className="p-2 lg:p-4">
      <div className="py-1 px-3 bg-primary text-white text-lg font-semibold md:hidden block mb-3 md:mb-0">
        Thông tin đơn đặt
      </div>
      {/* Desktop Layout */}
      <div className="hidden lg:flex lg:gap-6">
        <div className="w-[20%]">{renderTabs()}</div>
        <div className="w-[80%]">
          <Input
